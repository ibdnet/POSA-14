...
public class ThreadPoolDownloadService extends Service {
    ...
    public void onCreate() {
        ...
        mExecutor = Executors.newFixedThreadPool(MAX_THREADS, Executors.defaultThreadFactory());
    }
    ...
    public int onStartCommand(final Intent intent,
        ...
        Runnable downloadRunnable = new Runnable() {public void run() { 
        	...
        	//if (msg != null) {
        		DownloadUtils.downloadAndRespond(ThreadPoolDownloadService.this, intent.getData(), msg);//};
    	};};
